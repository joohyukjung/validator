...
public class FhirValidatorText {
...
//        instanceValidatorByProfile();
//        validateFiles();
        npm();

    }

    private static void instanceValidatorByProfile() throws Exception {
        Patient resource = new Patient();
        resource.getMeta().addProfile("http://hl7.org/fhir/us/core/StructureDefinition/us-core-patient");

//        Observation resource = new Observation();
//        resource.getMeta().addProfile("http://hl7.org/fhir/StructureDefinition/bp");
        ...
        String extensionUrl = "http://hl7.org/fhir/us/core/StructureDefinition/";
...
//        instanceValidator.setAnyExtensionsAllowed(true);
        instanceValidator.setCustomExtensionDomains(Collections.singletonList(extensionUrl));
...
//        validator.setValidateAgainstStandardSchema(false);
        ...
        ValidationResult result = validator.validateWithResult(resource);
//        ValidationResult result = validator.validateWithResult(resource, new ValidationOptions().addProfile("http://hl7.org/fhir/StructureDefinition/bp"));
...
//        System.out.println(jParser.encodeResourceToString(validator.validateWithResult(organization).toOperationOutcome()));
    }
...
//        ValidationResult result = validator.validateWithResult(obs, new ValidationOptions().addProfile("http://myprofile.com"));
    ...
    private static void validateFiles() throws Exception {
        ...
        File nextFile = new File("/Users/joohyukjung/Downloads/testuscore.json");
...
//        npmPackageSupport.loadPackageFromClasspath("classpath:package/us-core.tgz");
        npmPackageSupport.loadPackageFromClasspath("classpath:package/iteyes.myhw.core-1.0.1.tgz");
        ...
        Patient resource = new Patient();
        resource.getMeta().addProfile("https://simplifier.net/myhw/patient");

//        Practitioner resource = new Practitioner();
//        resource.getMeta().addProfile("https://simplifier.net/test-project6/practitionerstructure");
